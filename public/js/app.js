...
/***/ "./resources/js/Record/Level/Abstract.js":
/*!***********************************************!*\
  !*** ./resources/js/Record/Level/Abstract.js ***!
  \***********************************************/
...
var Level = /*#__PURE__*/function () {
  ...
  _createClass(Level, [{
    ...
    key: "displayTiles",
    value: function displayTiles() {// Extend method to call displayTile() for each level here;
    }
  }, {
    key: "displayTile",
    ...
    key: "addTileEvents",
    value: function addTileEvents(tileClass) {
      var _this = this;

      var tileLabelSelector = '.' + tileClass + ' label';
      var tileCheckboxSelector = '.' + tileClass + ' input[type="checkbox"]';
      document.querySelectorAll(tileLabelSelector).forEach(function (label) {
        return label.addEventListener('click', _this.handleTileLabelClick.bind(_this));
      });
    ...
    value: function handleTileLabelClick() {// Extend method for the relevant callback at each level
    }
  }, {
    ...
    value: function getCompleteUrl(url, id) {
      return url.replace('{record}', this.record.record.id).replace('{id}', id).replace('{check}', id);
    }
  }, {
    key: "getResetUrl",
    value: function getResetUrl(url, id) {
      return url.replace('{record}', this.record.record.id).replace('{id}', id);
    }
  }]);
...
/***/ "./resources/js/Record/Level/Checks.js":
/*!*********************************************!*\
  !*** ./resources/js/Record/Level/Checks.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Abstract */ "./resources/js/Record/Level/Abstract.js");
...
var Checks = /*#__PURE__*/function (_Level) {
  _inherits(Checks, _Level);

  var _super = _createSuper(Checks);
  ...
  function Checks() {
    ...
    _defineProperty(_assertThisInitialized(_this), "tileClass", 'tileCheck');
  ...
  _createClass(Checks, [{
    ...
    key: "addTileEvents",
    value: function addTileEvents() {
      _get(_getPrototypeOf(Checks.prototype), "addTileEvents", this).call(this, this.tileClass);
    }
  }, {
    key: "getCompleteUrl",
    value: function getCompleteUrl(id) {
      return _get(_getPrototypeOf(Checks.prototype), "getCompleteUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.checkCompleteUrl, id);
    }
  }, {
    key: "getResetUrl",
    value: function getResetUrl(id) {
      return _get(_getPrototypeOf(Checks.prototype), "getResetUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.checkResetUrl, id);
    }
  }]);

  return Checks;
}(_Abstract__WEBPACK_IMPORTED_MODULE_0__.Level);

/***/ }),

/***/ "./resources/js/Record/Level/Floors.js":
/*!*********************************************!*\
  !*** ./resources/js/Record/Level/Floors.js ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "Floors": () => (/* binding */ Floors)
/* harmony export */ });
/* harmony import */ var _Abstract__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Abstract */ "./resources/js/Record/Level/Abstract.js");
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../api */ "./resources/js/api.js");
function _typeof(obj) { "@babel/helpers - typeof"; if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
var Floors = /*#__PURE__*/function (_Level) {
  _inherits(Floors, _Level);

  var _super = _createSuper(Floors);
  ...
  function Floors() {
    ...
    _defineProperty(_assertThisInitialized(_this), "tileClass", 'tileFloor');
  ...
  _createClass(Floors, [{
    ...
    key: "addTileEvents",
    value: function addTileEvents() {
      _get(_getPrototypeOf(Floors.prototype), "addTileEvents", this).call(this, this.tileClass);
    }
  }, {
    key: "getCompleteUrl",
    value: function getCompleteUrl(id) {
      return _get(_getPrototypeOf(Floors.prototype), "getCompleteUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.floorCompleteUrl, id);
    }
  }, {
    key: "getResetUrl",
    value: function getResetUrl(id) {
      return _get(_getPrototypeOf(Floors.prototype), "getResetUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.floorResetUrl, id);
    }
  }, {
    key: "isFloorComplete",
    value: function isFloorComplete(floor) {
      var isComplete = true;
      floor.rooms.forEach(function (room) {
        return room.checks.forEach(function (check) {
...
/***/ "./resources/js/Record/Level/Rooms.js":
/*!********************************************!*\
  !*** ./resources/js/Record/Level/Rooms.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Rooms = /*#__PURE__*/function (_Level) {
  _inherits(Rooms, _Level);
  ...
  function Rooms() {
    ...
    _defineProperty(_assertThisInitialized(_this), "tileClass", 'tileRoom');
  ...
  _createClass(Rooms, [{
    ...
    key: "addTileEvents",
    value: function addTileEvents() {
      _get(_getPrototypeOf(Rooms.prototype), "addTileEvents", this).call(this, this.tileClass);
    }
  }, {
    key: "getCompleteUrl",
    value: function getCompleteUrl(id) {
      return _get(_getPrototypeOf(Rooms.prototype), "getCompleteUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.roomCompleteUrl, id);
    }
  }, {
    key: "getResetUrl",
    value: function getResetUrl(id) {
      return _get(_getPrototypeOf(Rooms.prototype), "getResetUrl", this).call(this, _api__WEBPACK_IMPORTED_MODULE_1__.roomResetUrl, id);
    }
  }, {
    key: "isRoomComplete",
    value: function isRoomComplete(room) {
      var isComplete = true;
      room.checks.forEach(function (check) {
        if (check.value == "0") isComplete = false;
      });
      return isComplete;
    }
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _api__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../api */ "./resources/js/api.js");
/* harmony import */ var _Level_Floors__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Level/Floors */ "./resources/js/Record/Level/Floors.js");
/* harmony import */ var _Level_Rooms__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./Level/Rooms */ "./resources/js/Record/Level/Rooms.js");
/* harmony import */ var _Level_Checks__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Level/Checks */ "./resources/js/Record/Level/Checks.js");
...
var Record = /*#__PURE__*/function () {
  function Record() {
    ...
    _defineProperty(this, "currentLevel", '');

    _defineProperty(this, "currentFloor", {});

    _defineProperty(this, "currentRoom", {});
  ...
  _createClass(Record, [{
    key: "find",
    value: function () {
      var _find = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios.post(_api__WEBPACK_IMPORTED_MODULE_1__.recordFindUrl);
    ...
    key: "displayFloors",
    value: function displayFloors() {
      this.currentLevel = 'floors';
      this.currentFloor = null;
      this.currentRoom = null;
      var floors = new _Level_Floors__WEBPACK_IMPORTED_MODULE_2__.Floors(this);
      floors.display();
    }
  }, {
    key: "displayRooms",
...
/* harmony export */   "roomCompleteUrl": () => (/* binding */ roomCompleteUrl),
/* harmony export */   "checkResetUrl": () => (/* binding */ checkResetUrl),
/* harmony export */   "checkCompleteUrl": () => (/* binding */ checkCompleteUrl)
/* harmony export */ });
...
var roomCompleteUrl = '/api/record/{record}/room/{id}/complete';
var checkResetUrl = '/api/record/{record}/check/{check}/reset';
var checkCompleteUrl = '/api/record/{record}/check/{check}/complete';
...
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ "./node_modules/@babel/runtime/regenerator/index.js");
/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _Record_Record__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Record/Record */ "./resources/js/Record/Record.js");
