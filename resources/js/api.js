...
export const roomResetUrl = '/api/record/{record}/room/{id}/reset';
export const roomCompleteUrl = '/api/record/{record}/room/{id}/complete';

export const checkResetUrl = '/api/record/{record}/check/{check}/reset';
export const checkCompleteUrl = '/api/record/{record}/check/{check}/complete';
